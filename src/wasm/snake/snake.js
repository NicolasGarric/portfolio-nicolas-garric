...
export class GameState {
    ...
    change_direction(dir) {
        wasm.gamestate_change_direction(this.__wbg_ptr, dir);
    }
    /**
     * @returns {Uint8Array}
     */
    get_cells() {
        const ret = wasm.gamestate_get_cells(this.__wbg_ptr);
     ...
     */
    get_height() {
        const ret = wasm.gamestate_get_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     ...
     */
    get_width() {
        const ret = wasm.gamestate_get_width(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
