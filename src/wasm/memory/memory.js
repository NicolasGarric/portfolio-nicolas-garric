...
export class GameState {
     ...
     */
    flip_card(index) {
        const ret = wasm.gamestate_flip_card(this.__wbg_ptr, index);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     ...
     */
    get_cards() {
        const ret = wasm.gamestate_get_cards(this.__wbg_ptr);
     ...
     */
    get_pairs_found() {
        const ret = wasm.gamestate_get_pairs_found(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_total_pairs() {
        const ret = wasm.gamestate_get_total_pairs(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
